  ...
  return (
    <div className="relative min-h-screen bg-slate-50 pt-32 pb-12 overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mb-16 text-center max-w-4xl mx-auto pt-8 animate-pulse">
          <div className="h-16 bg-white/20 rounded-2xl w-1/2 mx-auto mb-6" />
          <div className="h-6 bg-white/10 rounded w-3/4 mx-auto mb-2" />
          <div className="h-6 bg-white/10 rounded w-1/2 mx-auto" />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-pulse mt-12">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className={`bg-white rounded-[2rem] p-8 h-[300px] shadow-sm ${i === 5 ? 'md:col-span-2 lg:col-span-1' : ''}`}>
